      ...
      <div className="mx-auto grid max-w-screen-xl grid-cols-1 md:grid-cols-2 md:gap-8 lg:gap-4">
        <div className="place-items-center md:pt-6">
          <Image
            ...
            width={400}
            height={400}
            className="z-50 m-0 aspect-square size-72 border-8 border-white bg-white object-cover object-center pb-8 shadow-md drop-shadow-md md:size-80 md:rotate-6 md:shadow-lg md:drop-shadow-md lg:size-96"
            priority
            quality={100}
          />
          <Image
            ...
            width={400}
            height={400}
            className="z-50 m-0 hidden aspect-square size-72 -rotate-6 border-8 border-white bg-white object-cover object-center pb-8 shadow-lg drop-shadow-md md:block md:size-80 lg:size-96"
            priority
            quality={100}
          />
        </div>
